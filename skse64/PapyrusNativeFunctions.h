...
public:
	...
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x01250A20);
	// ??_7?$NativeFunction1@VActiveEffect@@XPEAVTESForm@@@BSScript@@6B@ entry 6
	DEFINE_MEMBER_FN(Impl_GetParam, UInt64 *, 0x012501C0, UInt32 idx, BSFixedString * nameOut, UInt64 * typeOut);
	DEFINE_MEMBER_FN(Impl_Invoke, UInt32, 0x01250340, UInt64 unk0, UInt64 unk1, VMClassRegistry * registry, VMState * unk3);
	// ??_7?$NativeFunction1@VActiveEffect@@XPEAVTESForm@@@BSScript@@6B@ entry 0x10
	DEFINE_MEMBER_FN(Impl_Fn10, BSFixedString *, 0x012502A0);
	// ??_7?$NativeFunction1@VActiveEffect@@XPEAVTESForm@@@BSScript@@6B@ entry 0x12
	DEFINE_MEMBER_FN(Impl_Fn12, bool, 0x012502C0, UInt32 idx, UInt64 out);
...
public:
	...
	DEFINE_MEMBER_FN(Impl_ctor, NativeFunction *, 0x012507D0, const char * fnName, const char * className, UInt32 unk0, UInt32 numParams);
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x01250A20);
