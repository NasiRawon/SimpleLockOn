...
public:
	...
	DEFINE_MEMBER_FN(Destroy, void, 0x01236D90);
	DEFINE_MEMBER_FN(GetVariable, SInt32, 0x01238100, BSFixedString * name);
	DEFINE_MEMBER_FN(GetFunction, IFunction*, 0x0123C2B0, const char * fnName);
};
