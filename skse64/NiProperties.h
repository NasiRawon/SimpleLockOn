...
public:
	...
	DEFINE_MEMBER_FN(InitializeShader, UInt32, 0x012C5220, BSGeometry * geometry);
	DEFINE_MEMBER_FN(SetMaterial, UInt32, 0x01291890, BSLightingShaderMaterial * material, bool unk1); // unk1 usually 1
	DEFINE_MEMBER_FN(SetFlags, UInt64, 0x01291780, UInt8 unk1, UInt8 unk2);
	DEFINE_MEMBER_FN(InvalidateMaterial, bool, 0x0019C3B0);
	DEFINE_MEMBER_FN(InvalidateTextures, void, 0x012C5600, UInt32 unk1); // unk1 usually 0, called after material Releases textures
};
